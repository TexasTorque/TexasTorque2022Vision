...
template<class Robot> void RunRobot(wpi::mutex& m, Robot** robot) {
...
template<class Robot> int StartRobot() {
    ...
    if (HAL_HasMain()) {
        ...
        // prefer to join, but detach to exit if it doesn't exit in a timely
        // manner
...
#define START_ROBOT_CLASS(_ClassName_)                                         \
    ...
    int StartRobotClassImpl() {                                                \
        return frc::StartRobot<_ClassName_>();                                 \
    }                                                                          \
    int main() {                                                               \
        return StartRobotClassImpl();                                          \
    }
...
class RobotBase {
  public:
     ...
     *
     * @return True if the robot us currently operating Autonomously while
