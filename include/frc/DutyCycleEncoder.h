...
class DutyCycleEncoder : public ErrorBase,
  ...
  public:
    ...
    /**
     * Construct a new DutyCycleEncoder attached to an existing DutyCycle
     * object.
     *
     ...
     *
     * This uses the duty cycle frequency to determine if the sensor is
     * connected. By default, a value of 100 Hz is used as the threshold, and
     * this value can be changed with SetConnectedFrequencyThreshold.
     *
    ...
    /**
     * Set the distance per rotation of the encoder. This sets the multiplier
     * used to determine the distance driven based on the rotation value from
     * the encoder. Set this value based on the how far the mechanism travels in
     * 1 rotation of the encoder, and factor in gearing reductions following the
