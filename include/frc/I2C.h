...
class I2C : public ErrorBase {
  public:
     ...
     * control over each transaction. If you intend to write multiple bytes in
     * the same transaction and do not plan to receive anything back, use
     * writeBulk() instead. Calling this with a receiveSize of 0 will result in
     * an error.
     *
     ...
     * auto-increment.
     *
     * @param registerAddress The base register to start reading from the
     * device.
