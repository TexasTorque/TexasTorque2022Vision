...
class DriverStation : public ErrorBase {
  public:
     ...
     *
     * @return True if the robot is explicitly disabled or the DS is not
     * connected
     */
    ...
    /**
     * Check if the DS is commanding teleop mode and if it has enabled the
     * robot.
     *
     ...
     * an approximate match time. The value will count down the time remaining
     * in the current period (auto or teleop).
     *
     * Warning: This is not an official time (so it cannot be used to dispute
     * ref calls or guarantee that a function will trigger before the match
     * ends).
     *
