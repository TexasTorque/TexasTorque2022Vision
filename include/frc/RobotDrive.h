...
class RobotDrive : public MotorSafety {
  public:
     ...
     *                        10-19 are on the MXP port
     * @param frontRightMotor Front right motor channel number. 0-9 are
     ...
     * objects.
     *
     * The SpeedController version of the constructor enables programs to use
     * the RobotDrive classes with subclasses of the SpeedController objects,
     * for example, versions with ramping or reshaping of the curve to suit
     * motor bias or deadband elimination.
     *
     ...
     * represents stopped and not turning. curve < 0 will turn left and curve >
     * 0 will turn right.
     *
     ...
     * for right turn.
     *
     * Set curve = e^(-r/w) to get a turn radius r for wheelbase w of your
     * robot. Conversely, turn radius r = -ln(curve)*w for a given value of
     ...
     *                      The Y-axis will be selected for forwards/backwards
     * and the X-axis will be selected for rotation rate.
     * @param squaredInputs If true, the sensitivity will be decreased for small
     *                      values
     */
     ...
     * degrees.
     * When looking at the wheels from the top, the roller axles should form an
     * X across the robot.
     *
     * This is designed to be directly driven by joystick axes.
     *
     * @param x         The speed that the robot should drive in the X
     * direction.
     *                  [-1.0..1.0]
     * @param y         The speed that the robot should drive in the Y
     * direction. This input is inverted to match the forward == -1.0 that
     ...
     */
    virtual void SetLeftRightMotorOutputs(double leftOutput,
                                          double rightOutput);
