...
class Compressor : public ErrorBase,
  ...
  public:
     ...
     * pressure is low.
     *
     * @return True if closed loop control of the compressor is enabled. False
     * if disabled.
     */
    bool GetClosedLoopControl() const;

    /**
     * Query if the compressor output has been disabled due to high current
     * draw.
     *
     ...
     * (sticky).
     *
     * A sticky fault will not clear on device reboot, it must be cleared
     * through code or the webdash.
     *
     ...
     *         appear to be wired, i.e. compressor is not drawing enough
     * current.
     */
     ...
     *
     * If a sticky fault is set, then it will be persistently cleared.
     * Compressor drive maybe momentarily disable while flags are being cleared.
     * Care should be taken to not call this too frequently, otherwise normal
     * compressor functionality may be prevented.
     *
