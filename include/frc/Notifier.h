  ...
  public:
    ...
    template<typename Callable, typename Arg, typename... Args,
             typename = std::enable_if_t<
                     std::is_invocable_v<Callable, Arg, Args...>>>
     ...
     * interrupt occurs, the event will be immediately requeued for the same
     * time interval.
     *
     ...
     *
     * @param realTime Set to true to set a real-time priority, false for
     * standard priority.
     * @param priority Priority to set the thread to. For real-time, this is
     * 1-99 with 99 being highest. For non-real-time, this is forced to 0. See
     * "man 7 sched" for more details.
