...
class AnalogAccelerometer : public ErrorBase,
  ...
  public:
     ...
     *
     * @param channel The channel number for the analog input the accelerometer
     * is connected to
     */
     ...
     * particularly useful if the port is going to be read as an analog channel
     * as well as through the Accelerometer class.
     *
