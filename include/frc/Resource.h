...
class Resource : public ErrorBase {
  public:
     ...
     *
     * @param r        address of the caller's Resource pointer. If *r ==
     * nullptr, this will construct a Resource and make *r point to it. If *r !=
     * nullptr, i.e. the caller already has a Resource instance, this won't do
     * anything.
     ...
     *
     * Allocate a bool array of values that will get initialized to indicate
     * that no resources have been allocated yet. The indicies of the resources
     * are [0 .. elements - 1].
     */
     ...
     * resource value within the range is located and returned after it is
     * marked allocated.
     */
     ...
     *
     * The user requests a specific resource value, i.e. channel number and it
     * is verified unallocated, then returned.
     */
     ...
     * for a channel assignment class, Free will release the resource value so
     * it can be reused somewhere else in the program.
     */
