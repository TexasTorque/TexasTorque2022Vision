...
class AnalogInput : public ErrorBase,
  ...
  public:
     ...
     *
     * Using averaging will cause this value to be more stable, but it will
     * update more slowly.
     *
     ...
     * of averaged samples is 2^bits. The averaging is done automatically in the
     * FPGA.
     *
     ...
     * and accelerometers to take the device offset into account when
     * integrating.
     *
