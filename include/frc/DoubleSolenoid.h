...
class DoubleSolenoid : public SolenoidBase,
  ...
  public:
     ...
     *
     * If the solenoid is set to forward, it'll be set to reverse. If the
     * solenoid is set to reverse, it'll be set to forward. If the solenoid is
     * set to off, nothing happens.
     */
    void Toggle();
