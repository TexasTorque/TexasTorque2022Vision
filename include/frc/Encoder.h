...
class Encoder : public ErrorBase,
  ...
  public:
     ...
     *
     * @param aChannel         The a channel DIO channel. 0-9 are on-board,
     * 10-25 are on the MXP port
     * @param bChannel         The b channel DIO channel. 0-9 are on-board,
     * 10-25 are on the MXP port
     ...
     *                         falling edges are counted. If 1X or 2X are
     * selected then a counter object will be used and the returned value will
     * either exactly match the spec'd count or be double (2x) the spec'd count.
     */
     ...
     *
     * Returns the period of the most recent Encoder pulse in seconds. This
     ...
     *                  the FPGA will report the device stopped. This is
     * expressed in seconds.
     */
    WPI_DEPRECATED(
            "Use SetMinRate() in favor of this method.  This takes unscaled "
            "periods "
     ...
     * the count value from the encoder.
     *
