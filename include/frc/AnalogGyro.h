...
class AnalogGyro : public GyroBase {
  public:
     ...
     * only be used on on-board Analog Inputs 0-1.
     */
    ...
    /**
     * Gyro constructor using the Analog Input channel number with parameters
     * for presetting the center and offset values. Bypasses calibration.
     *
     * @param channel The analog channel the gyro is connected to. Gyros can
     * only be used on on-board Analog Inputs 0-1.
     ...
     * angle is continuous, that is it will continue from 360->361 degrees. This
     ...
     * uses it in subsequent calculations to allow the code to work with
     * multiple gyros. This value is typically found in the gyro datasheet.
     *
     ...
     * significant drift in the gyro and it needs to be recalibrated after it
     * has been running.
     */
    void Reset() final;
