...
class NetworkTable final : public ITable {
  ...
  public:
     ...
     */
    WPI_DEPRECATED("use NetworkTableInstance::StartServer() or "
     ...
     */
    WPI_DEPRECATED("use NetworkTableInstance::StopServer() or "
     ...
     */
    WPI_DEPRECATED("use NetworkTableInstance::SetServerTeam() or "
     ...
     * mode
     */
    WPI_DEPRECATED("use NetworkTableInstance::SetServer() or "
                   "NetworkTableInstance::StartClient() instead")
     ...
     */
    WPI_DEPRECATED("use the appropriate parameters to "
                   "NetworkTableInstance::SetServer(), "
     ...
     */
    WPI_DEPRECATED("use NetworkTableInstance::StartDSClient() and "
     ...
     */
    WPI_DEPRECATED("use the appropriate parameter to "
    ...
    static const char*
    LoadPersistent(StringRef filename,
     ...
     */
    WPI_DEPRECATED("use NetworkTableInstance::GetTable() or "
    ...
    WPI_DEPRECATED("use AddEntryListener() instead with flags value of "
                   "NT_NOTIFY_NEW | "
                   "NT_NOTIFY_UPDATE")
     ...
     */
    std::vector<double>
    GetNumberArray(StringRef key, ArrayRef<double> defaultValue) const override;
    ...
    GetStringArray(StringRef key,
                   ArrayRef<std::string> defaultValue) const override;
     ...
     * value if there is no value associated with the key
     *
     * @note This makes a copy of the raw contents.  If the overhead of this is
     * a concern, use GetValue() instead.
     */
     ...
     */
    const char*
    LoadEntries(const Twine& filename,
                std::function<void(size_t line, const char* msg)> warn);
};
