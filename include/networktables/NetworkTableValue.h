...
class Value final {
  ...
  public:
    ...
    MakeBooleanArray(std::initializer_list<bool> value, uint64_t time = 0) {
     ...
     */
    static std::shared_ptr<Value>
    MakeBooleanArray(std::initializer_list<int> value, uint64_t time = 0) {
        return MakeBooleanArray(wpi::makeArrayRef(value.begin(), value.end()),
                                time);
    }
     ...
     */
    static std::shared_ptr<Value>
    MakeDoubleArray(std::initializer_list<double> value, uint64_t time = 0) {
        return MakeDoubleArray(wpi::makeArrayRef(value.begin(), value.end()),
                               time);
    }
     ...
     */
    static std::shared_ptr<Value>
    MakeStringArray(std::initializer_list<std::string> value,
                    uint64_t time = 0) {
        return MakeStringArray(wpi::makeArrayRef(value.begin(), value.end()),
                               time);
    }
     ...
     */
    static std::shared_ptr<Value>
    MakeStringArray(std::vector<std::string>&& value, uint64_t time = 0);
