...
template<class T> class ErrorOr {
  ...
  public:
    template<class E>
    ErrorOr(E ErrorCode, typename std::enable_if<
    ...
    explicit ErrorOr(const ErrorOr<OtherT>& Other,
                     typename std::enable_if<!std::is_convertible<
                             OtherT, const T&>::value>::type* = nullptr) {
        copyConstruct(Other);
    }
    ...
    // This might eventually need SFINAE but it's more complex than
    // is_convertible & I'm too lazy to write it right now.
    template<class OtherT>
    explicit ErrorOr(
