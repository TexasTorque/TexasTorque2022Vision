...
class DebugEpochBase {
  ...
  public:
    ...
    /// expects the routines modifying the data structure to call incrementEpoch
    /// when they make an iterator-invalidating modification.
    ///
    class HandleBase {
      ...
      public:
        ...
        /// this handle points into.  Can be used to check if two iterators
        /// point into the same data structure.
        const void* getEpochAddress() const {
            return EpochAddress;
        }
    };
