...
class HttpServerConnection {
  ...
  protected:
     ...
     *
     * The implementation should read request details from m_request and call
     * the appropriate Send() functions to send a response back to the client.
     */
     ...
     * A browser should connect for each file and not serve files from its
     * cache.
     *
     ...
     * @param contentLength Length of content.  If 0 is provided, m_keepAlive
     ...
     * This provides standard code responses for 400, 401, 403, 404, 500, and
     * 503. Other codes will be reported as 501.  For arbitrary code handling,
