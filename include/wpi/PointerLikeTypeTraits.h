...
template<> struct PointerLikeTypeTraits<void*> {
    ...
    /// that malloc returns objects at least 4-byte aligned. However, this may
    /// be wrong, or pointers may be from something other than malloc. In this
    /// case, you should specify a real typed pointer or avoid this template.
    ///
