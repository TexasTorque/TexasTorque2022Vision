...
class WebSocketServerHelper {
  public:
     ...
     *         Second item is the matched protocol if a match was made,
     * otherwise is empty.
     */
    ...
    MatchProtocol(std::initializer_list<StringRef> protocols) {
...
class WebSocketServer : public std::enable_shared_from_this<WebSocketServer> {
  ...
  public:
    ...
    struct ServerOptions {
        /**
         * Checker for URL.  Return true if URL should be accepted.  By default
         * all URLs are accepted.
         */
     ...
     */
    static std::shared_ptr<WebSocketServer>
    Create(uv::Stream& stream, std::initializer_list<StringRef> protocols,
           const ServerOptions& options = ServerOptions{}) {
