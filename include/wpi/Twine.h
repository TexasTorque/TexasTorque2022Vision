...
class Twine {
    ...
    enum NodeKind : unsigned char {
        /// An empty string; the result of concatenating anything with it is
        /// also
        /// empty.
        NullKind,
        ...
        /// A pointer to a long long value, to render as a signed decimal
        /// integer.
        DecLLKind,
  ...
  public:
    ...
    /// Append the concatenated string into the given SmallString or
    /// SmallVector.
    ...
    StringRef getSingleStringRef() const {
        assert(isSingleStringRef() &&
               "This cannot be had as a single stringref!");
        switch (getLHSKind()) {
        default:
