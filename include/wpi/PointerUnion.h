...
template<typename PT1, typename PT2> class PointerUnion {
  ...
  public:
    ...
    PointerUnion(PT2 V)
        : Val(const_cast<void*>(
                      PointerLikeTypeTraits<PT2>::getAsVoidPointer(V)),
              1) {
    }
    ...
    bool isNull() const {
        ...
        return !PointerLikeTypeTraits<PT1>::getFromVoidPointer(
                Val.getPointer());
    }
    ...
    PT1* getAddrOfPtr1() {
        ...
        assert(get<PT1>() == Val.getPointer() &&
               "Can't get the address because PointerLikeTypeTraits changes "
               "the ptr");
    ...
    const PointerUnion& operator=(const PT1& RHS) {
        Val.initWithPointer(const_cast<void*>(
                PointerLikeTypeTraits<PT1>::getAsVoidPointer(RHS)));
        return *this;
    }
    const PointerUnion& operator=(const PT2& RHS) {
        Val.setPointerAndInt(
                const_cast<void*>(
                        PointerLikeTypeTraits<PT2>::getAsVoidPointer(RHS)),
                1);
        return *this;
    }
...
template<typename PT1, typename PT2, typename PT3> class PointerUnion3 {
  ...
  public:
    ...
    template<typename T> int is() const {
        ...
        using Ty = typename ::wpi::PointerUnionTypeSelector<
                PT1, T, IsInnerUnion,
                ::wpi::PointerUnionTypeSelector<PT2, T, IsInnerUnion,
                                                IsPT3>>::Return;
...
struct PointerLikeTypeTraits<PointerUnion3<PT1, PT2, PT3>> {
    ...
    // The number of bits available are the min of the two pointer types.
    enum {
        NumLowBitsAvailable = PointerLikeTypeTraits<typename PointerUnion3<
                PT1, PT2, PT3>::ValTy>::NumLowBitsAvailable
    };
};
...
struct PointerLikeTypeTraits<PointerUnion4<PT1, PT2, PT3, PT4>> {
    ...
    // The number of bits available are the min of the two pointer types.
    enum {
        NumLowBitsAvailable = PointerLikeTypeTraits<typename PointerUnion4<
                PT1, PT2, PT3, PT4>::ValTy>::NumLowBitsAvailable
    };
};
