 ...
 * old values.
 */
template<class T, size_t N> class static_circular_buffer {
  public:
    ...
    const_iterator end() const {
        return const_iterator(this,
                              ::wpi::static_circular_buffer<T, N>::size());
    }
    ...
    /**
     * Push a new value onto the front of the buffer that is constructed with
