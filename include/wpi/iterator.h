...
class iterator_facade_base
  ...
  public:
    DerivedT operator+(DifferenceTypeT n) const {
        ...
        static_assert(IsRandomAccess, "The '+' operator is only defined for "
                                      "random access iterators.");
    ...
    DerivedT& operator--() {
        static_assert(IsBidirectional, "The decrement operator is only defined "
    ...
    bool operator>(const DerivedT& RHS) const {
        static_assert(IsRandomAccess, "Relational operators are only defined "
  ...
  public:
    ...
    DerivedT& operator+=(difference_type n) {
        static_assert(BaseT::IsRandomAccess,
                      "The '+=' operator is only defined for random access "
                      "iterators.");
        I += n;
    ...
    difference_type operator-(const DerivedT& RHS) const {
        static_assert(BaseT::IsRandomAccess, "The '-' operator is only defined "
                                             "for random access iterators.");
        return I - RHS.I;
    }
...
struct pointee_iterator
    : iterator_adaptor_base<pointee_iterator<WrappedIteratorT, T>,
                            WrappedIteratorT,
