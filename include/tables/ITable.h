...
class WPI_DEPRECATED("Use NetworkTable directly") ITable {
  public:
     ...
     */
    virtual std::shared_ptr<nt::NetworkTable>
    GetSubTable(const wpi::Twine& key) const = 0;
     ...
     * does not exist
     */
    virtual std::shared_ptr<nt::Value>
    GetValue(const wpi::Twine& key) const = 0;
    ...
    GetBooleanArray(wpi::StringRef key,
                    wpi::ArrayRef<int> defaultValue) const = 0;
    ...
    GetNumberArray(wpi::StringRef key,
                   wpi::ArrayRef<double> defaultValue) const = 0;
     ...
     */
    virtual bool
    SetDefaultStringArray(wpi::StringRef key,
                          wpi::ArrayRef<std::string> defaultValue) = 0;
    ...
    GetStringArray(wpi::StringRef key,
                   wpi::ArrayRef<std::string> defaultValue) const = 0;
     ...
     * @param flags bitmask of NT_NotifyKind specifying desired notifications
     */
    virtual void AddTableListenerEx(wpi::StringRef key,
