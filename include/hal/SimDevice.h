 ...
 */
HAL_SimValueHandle
HAL_CreateSimValueEnumDouble(HAL_SimDeviceHandle device, const char* name,
                             int32_t direction, int32_t numOptions,
                             const char** options, const double* optionValues,
                             int32_t initialValue);
...
class SimValue {
  public:
    ...
    HAL_Value GetValue() const {
        return HAL_GetSimValue(m_handle);
    }
    ...
    void SetValue(const HAL_Value& value) {
        HAL_SetSimValue(m_handle, value);
    }
...
class SimInt : public SimValue {
  public:
     ...
     */
    int32_t Get() const {
        return HAL_GetSimValueInt(m_handle);
    }
    ...
    void Set(int32_t value) {
        HAL_SetSimValueInt(m_handle, value);
    }
...
class SimLong : public SimValue {
  public:
     ...
     */
    int64_t Get() const {
        return HAL_GetSimValueLong(m_handle);
    }
    ...
    void Set(int64_t value) {
        HAL_SetSimValueLong(m_handle, value);
    }
...
class SimDouble : public SimValue {
  public:
     ...
     */
    double Get() const {
        return HAL_GetSimValueDouble(m_handle);
    }
    ...
    void Set(double value) {
        HAL_SetSimValueDouble(m_handle, value);
    }
...
class SimEnum : public SimValue {
  public:
     ...
     */
    int32_t Get() const {
        return HAL_GetSimValueEnum(m_handle);
    }
     ...
     */
    void Set(int32_t value) {
        HAL_SetSimValueEnum(m_handle, value);
    }
};
...
class SimBoolean : public SimValue {
  public:
    ...
    /**
     * Wraps a simulated value handle as returned by
     ...
     */
    bool Get() const {
        return HAL_GetSimValueBoolean(m_handle);
    }
     ...
     */
    void Set(bool value) {
        HAL_SetSimValueBoolean(m_handle, value);
    }
};
...
class SimDevice {
  public:
     ...
     * name, e.g. "device[1]".
     *
     * If not in simulation, results in an "empty" object that evaluates to
     ...
     * channel in brackets to the device name, e.g. passing index=1 and
     * channel=2 results in "device[1,2]" for the device name.
     *
     * If not in simulation, results in an "empty" object that evaluates to
     * false in a boolean context.
     *
     ...
     */
    SimInt CreateInt(const char* name, int32_t direction,
                     int32_t initialValue) {
    ...
    SimDouble CreateDouble(const char* name, int32_t direction,
                           double initialValue) {
        return HAL_CreateSimValueDouble(m_handle, name, direction,
                                        initialValue);
    }
    ...
    SimBoolean CreateBoolean(const char* name, int32_t direction,
                             bool initialValue) {
        return HAL_CreateSimValueBoolean(m_handle, name, direction,
                                         initialValue);
    }
