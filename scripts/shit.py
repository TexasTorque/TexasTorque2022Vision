#
# Basic vision script for Python. I don't know what it does!
#
...
def main():
    is_red = True; # this will be read from networktables
    
    threshold = ((170, 70, 50), (180, 255, 255)) if is_red else ((90, 50, 70), (128, 255, 255)) 
    ...
    vision_nt = NetworkTables.getTable('ball_detection')
